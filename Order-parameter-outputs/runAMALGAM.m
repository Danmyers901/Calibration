% This code was modified by DM 9/23/20 to create the OrdSet output, which is an ordered list of parameter sets and ObjVals used in the models.
...
Extra.nsub=64;              % Total number of subbasins in model
Extra.start_year = 1950;    % Start year of simulation after model warmup
...
Extra.nyear = 50;            % Number of year of model simulation after model warmup
Extra.CalStartDate = datenum(1950,1,1); % Calibration start date
Extra.CalEndDate=datenum(1999,12,31);   % Calibration end date


Extra.SimulationDir= '/N/slate/myersdt/StJoe_misc/StJoe_test2/Simulations';    %Define the simulation directory
Extra.InputDir= '/N/slate/myersdt/StJoe_misc/StJoe_test2';            %Define the input folder location
...
% Run the AMALGAM code and obtain non-dominated solution set (modified by
% DM 9/27/20)
[output,ParGen,ObjVals,ParSet,SimRes,OrdSet] = AMALGAM(AMALGAMPar,ParRange,Extra,Fpareto);
