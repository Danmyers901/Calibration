...
unix_command = 'chmod 777 swat681_linux';
unix(unix_command);
...
calibration_outlets_OF3 = [11 85 86 96 98 115 219 237 243 340 343 520 529 538 540 548 579 590 598 606 608 617 623 783 823 835 887 936 971 980 1026 1092 1095 1102 1109 1121 1308 1362 1393 1410 1430 1452 1626 1665 1749 1757 1775 1886 1916 1924];
...
%%%%MEAN OF OF values -- comment out if not used
 OF2=mean([OF_sub_OF3]); % Note I changed this to OF2
