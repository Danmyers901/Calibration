 function [OF1,OF2,OF3,OF4,POSITION] = mcalib(iRun,X, Extra) % modified by DM 9/23/20
global n_sub file_id

% This file has been modified to work with the new quick rchproc_fast.m and hruproc_fast.m
% This program has been modified by DM 9/23/20 to produce an orderly position output.
...
calibration_outlets_OF3 = [11 73 85 86 96 98 219 237 243 340 343 520 529 538 540 548 579 590 598 606 608 617 623 783 820 823 835 936 971 987 1029 1092 1095 1102 1109 1121 1308 1362 1393 1410 1430 1452 1626 1665 1749 1757 1775 1886 1916 1924];
%calibration_outlets_OF3 = [11];
...
hruproc_fast(iVars,n_sub,calibration_outlets_OF3,start_year,n_years);
...
for i = 1:length(calibration_outlets_OF3);
  ...
  outstats_OF3 = calstats_FallWinterSpring(calibration_outlets_OF3(i),CalStartDate,CalEndDate);
  %%%%%%%%%%%%%%%%%%CHANGE STAT TO WHATEVER YOU WANT THE OF TO
  %%%%%%%%%%%%%%%%%%BE%%%%%%%%%%%%
  OF_sub_OF3(:,i) = -1*outstats_OF3.mae; %the -1 represents that the OF needs to be minimized
